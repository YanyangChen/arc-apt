...
// import arc.apf.Static.APTtMapping;

// @Controller
// @Scope("session")
// @ACFgFunction(id="APTF001")
// @RequestMapping(value=APTtMapping.APTF001)
// public class APTc002 extends ACFaAppController {
// 
// 	@RequestMapping(value=APTtMapping.APTF001_MAIN, method=RequestMethod.GET)
...
@ACFgFunction(id="APTF001")
@RequestMapping(value=APTtMapping.APTF001)
public class APTc001 extends ACFaAppController {
        ...
        public Search() {
          ...
          //SQL to combine two tables to form one grid in browser function
            setCustomSQL("select * from (select a.payment_form_no, a.request_date, a.section_id, a.request_department, "
                    ...
                    "where (a.supplier_code = b.supplier_code) and (a.section_id = '07') and (a.supplier_code <> 'CASH')) ");
  ...
  //     model.addAttribute("subsectionidselect", SectionService.getAllSubSectionName8());
       model.addAttribute("subsectionidselect", SectionService.getAllSubSectionName7());
    ...
    @RequestMapping(value=APTtMapping.APTF001_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APTtMapping.APTF001_GET_SUPPLIER_NAME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APTtMapping.APTF001_GET_PAYMENTDETAILS_TABLE_AJAX, method=RequestMethod.POST) //get rows of the second grid
    @ResponseBody
   ...
   //                 + "where pr.payment_form_no = pd.payment_form_no )");
     ...
     @RequestMapping(value=APTtMapping.APTF001_GET_FORM_AJAX, method=RequestMethod.POST)
        @ResponseBody
     ...
     @ACFgTransaction
        @RequestMapping(value=APTtMapping.APTF001_SAVE_AJAX, method=RequestMethod.POST)
        @ResponseBody
            ...
            ARCmPaymentRequest lastItem = paymentrequestDao.saveItems(amendments, new ACFiSQLAssWriteInterface<ARCmPaymentRequest>(){
                ...
                public boolean delete(ARCmPaymentRequest oldItem, ACFdSQLAssDelete ass) throws Exception {
                	if(!oldItem.despatch_date.equals(Timestamp.valueOf("1900-01-01 00:00:00"))){
                		throw exceptionService.error("APT004E");
                	}
