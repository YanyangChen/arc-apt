...
<div class="col-md-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="PAYMENT REQUEST LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="aptf001-search.ajax" readonly="true" autoLoad="false">
...
<!--   <acf:Region id="reg_form" title="PAYMENT REQUEST LIST">-->
			   		...
			   		<acf:Bind on="change"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/apt/aptf001/aptf001-apt-get-supplier-name.ajax",
								data   : JSON.stringify({
	...
	<acf:Region id="payment_details" title="PAYMENT DETAILS" type="list">			
		<div class="col-md-12">
			<acf:Grid id="grid_paymentdetails" url="aptf001-get-paymentdetails-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
...
Controller.setOption({
    ...
    getUrl: "aptf001-get-form.ajax",
	saveUrl: "aptf001-save.ajax",
